...
export type TransactionResult =
  import("./wallet-account-read-only.js").TransactionResult;
export type TransferOptions =
  import("./wallet-account-read-only.js").TransferOptions;
export type TransferResult =
  import("./wallet-account-read-only.js").TransferResult;
export type KeyPair = {
  /**
   * - The public key.
   */
