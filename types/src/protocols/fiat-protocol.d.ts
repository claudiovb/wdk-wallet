...
export default abstract class FiatProtocol implements IFiatProtocol {
   ...
   */
  abstract quoteSell(
    options: Omit<SellOptions, "refundAddress">,
  ): Promise<FiatQuote>;
  /**
...
export type IWalletAccountReadOnly =
  import("../wallet-account-read-only.js").IWalletAccountReadOnly;
...
export type BuyOptions = BuyCommonOptions &
  (BuyExactCryptoAmountOptions | BuyWithFiatAmountOptions);
...
export type SellOptions = SellCommonOptions &
  (SellExactCryptoAmountOptions | SellForFiatAmountOptions);
